...
$preview = $db->find($id);
$output = $render->getFullArticle($preview);
                ...
                <div class="col-md-12">
                    <div class="alert alert-info"><?php echo $config['titre']; ?></div>
                     <ul class="nav nav-tabs">
                        ...
                        <li><a href="<?php echo "tableau.php?etiquette=$etiquette"?>">Tableau</a></li>
                        <li class="active"><a href="<?php echo "previsualisation.php?etiquette=$etiquette"?>">Prévisualisation</a></li>
                    </ul> 
